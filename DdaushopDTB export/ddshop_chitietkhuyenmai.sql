...
CREATE TABLE `chitietkhuyenmai` (
  ...
  KEY `FK_chitietkhuyenmai_chitietsanpham` (`masanpham`),
  CONSTRAINT `FK_chitietkhuyenmai_chitietsanpham` FOREIGN KEY (`masanpham`) REFERENCES `chitietsanpham` (`masanpham`)
